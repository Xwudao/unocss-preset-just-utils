...
import { colorResolver, colorableShadows, h, splitShorthand } from "../_utils";
...
export const textStrokes: Rule<Theme>[] = [
  ...
  [
    ...
    ([, opacity]) => ({
      "--un-text-stroke-opacity": h.bracket.percent.cssvar(opacity),
    }),
...
export const textShadows: Rule<Theme>[] = [
  ...
  [
    ...
    ([, opacity]) => ({
      "--un-text-shadow-opacity": h.bracket.percent.cssvar(opacity),
    }),
